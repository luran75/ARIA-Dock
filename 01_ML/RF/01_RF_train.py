...
def train_model_with_optuna(fingerprints, docking_scores, r, n_trials=50, n_jobs=5):
    ...
    with tqdm(total=n_trials, desc="Random Forest Optimization Trials") as pbar:
    ...
    #optimization_history.savefig(f"optuna_optimization_history_r{r}_RF-regression.jpg", format="jpg")
    #param_importance.savefig(f"optuna_param_importance_RF-regression_r{r}.jpg", format="jpg")
